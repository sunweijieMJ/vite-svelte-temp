...
export default [
    ...
    },
    {
        ...
        title: i18n.t('configMenu.t24'),
        routeName: 'rights',
        routePath: '/rights',
        children: [
            {
                iconCode: 'iconsecond_menu_user',
                title: i18n.t('configMenu.t25'),
                routeName: 'usermanage',
                routePath: '/rights/usermanage',
                children: [
                    {
                        tab: true,
                        title: i18n.t('configMenu.t26'),
                        routeName: 'userlist',
                        routePath: '/rights/usermanage/userlist',
                        permissions: ['user_query', 'user_insert', 'user_disable', 'user_update', 'user_pwd', 'user_assign_role', 'user_rest_pwd'],
                    },
                    {
                        tab: true,
                        title: i18n.t('configMenu.t27'),
                        routeName: 'rolelist',
                        routePath: '/rights/usermanage/rolelist',
                        permissions: ['role_query', 'role_insert', 'role_disable', 'role_update', 'role_relation_user_jump'],
                    },
                    {
                        tab: true,
                        title: i18n.t('configMenu.t28'),
                        routeName: 'datasetlist',
                        routePath: '/rights/usermanage/datasetlist',
                        permissions: ['data_group_query', 'data_group_create', 'data_group_enable', 'data_group_update', 'data_group_relation_user'],
                    },
                    {
                        tab: true,
                        title: i18n.t('configMenu.t29'),
            ...
            },
            {
                ...
                title: i18n.t('configMenu.t31'),
                routeName: 'logmanage',
                routePath: '/rights/logmanage',
                children: [
                    {
                        tab: true,
                        title: i18n.t('configMenu.t32'),
                        routeName: 'loglist',
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                title: i18n.t('configMenu.t41'),
                routeName: 'brandmanage',
                routePath: '/pim/brandmanage',
                children: [
                    {
                        tab: true,
                        title: i18n.t('configMenu.t42'),
                        routeName: 'brandlist',
            ...
            },
            {
                ...
                title: i18n.t('configMenu.t46'),
                routeName: 'labelmanage',
                routePath: '/pim/labelmanage',
                children: [
                    {
                        tab: true,
                        title: i18n.t('configMenu.t47'),
                        routeName: 'labellist',
                        routePath: '/pim/labelmanage/labellist',
                    },
                    {
                        tab: true,
                        title: i18n.t('configMenu.t48'),
        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    ...
                    {
                        title: i18n.t('configMenu.t92'),
                        routeName: 'memberintegral',
                        routePath: '/crm/memberloyalty/memberintegral',
                        children: [
                            {
                                tab: true,
                                title: i18n.t('configMenu.t93'),
                                routeName: 'integralbasesetting',
                                routePath: '/crm/memberloyalty/memberintegral/integralbasesetting',
                                permissions: [],
                            },
                            {
                                tab: true,
                                title: i18n.t('configMenu.t94'),
                                routeName: 'tradingbonuspoints',
                                routePath: '/crm/memberloyalty/memberintegral/tradingbonuspoints',
                                permissions: [],
                            },
                            {
                                tab: true,
                                title: i18n.t('configMenu.t95'),
                                routeName: 'interactiveintegraltask',
                                routePath: '/crm/memberloyalty/memberintegral/interactiveintegraltask',
                                permissions: [],
                            },
                        ],
                    },
            ...
            },
            {
                ...
                title: i18n.t('configMenu.t96'),
                routeName: 'more',
                routePath: '/crm/more',
                children: [
                    {
                        title: i18n.t('configMenu.t97'),
                        routeName: 'datamanage',
                        routePath: '/crm/more/datamanage',
                        children: [
                            {
                                tab: true,
                                title: i18n.t('configMenu.t98'),
                                routeName: 'metadata',
